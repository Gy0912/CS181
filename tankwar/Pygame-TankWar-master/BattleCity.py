...
import numpy as np
from Player1 import main as initialize_agent
from Player1 import QLearningAgent
...
class Game(object):
    ...
    def get_state(self):
        ...
        return np.random.randint(0, self.agent.state_size)
    ...
    def run(self):
        while True:
            ...
            if done:
                self.agent.log_training(self.level, self.score, self.lives)
                self.reset()
